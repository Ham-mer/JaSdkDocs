...
| バージョン   | 日付       | 更新情報                          |
|------------|------------|---------------------------------|
| 19.0.1.0   | 2020/4/20  |DFP SDK 19.0.1 に対応，Android APIレベルは16または以上になります。<br><br>NativeAdなどのsetMuted()で動画のおとの調整はできます。<br>[AdLimeSdk](./init.md)到を 1.10.3 以降のバージョンまでアップデートする必要があります|
...
| 18.3.0.0   | 2020/2/7   |DFP SDK 18.3.0 に対応，AndroidXに移します|
