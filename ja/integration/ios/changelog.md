...
| バージョン    | 日付          | 内容                                  |
| ----------- | ------------- | ------------------------------------ |
| 1.8.7       | 2020/7/29     | - AdLimeAdLoaderにおける「destoryAd」は「destroyAd」に修正されました<br>- 安定性を改善します|
| 1.8.6       | 2020/7/17     | メモリ管理を最適化して、deallocのタイミングで広告インスタンスのdestroyメソッドをコールすることができなくなります；メモリ解放の効率を上げます|
