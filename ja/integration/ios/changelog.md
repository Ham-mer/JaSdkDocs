...
| バージョン    | 日付          | 内容                                  |
| ----------- | ------------- | ------------------------------------ |
| 1.6.7       | 2020/2/5      | Adlomeは新たな方法（setNetworkDebugMode、setNetworkTestMode）を追加します。この方法でネットワークを調整モード、テストモードに設定できます。[初期化](./init.md)を参考してください。（ネットワークに対応するアダプターも更新する必要があります）|
